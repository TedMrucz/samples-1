...
namespace ItemsFilter.View 
{
    ...
    public abstract class FilterViewBase<T> : Control, IFilterView
    {
        ...
        {
            CommandManager.RegisterClassCommandBinding(typeof(FilterViewBase<T>), new CommandBinding(FilterCommand.Clear, ClearFilterExecute, ClearFilterCanExecute));
        }
        ...
        public static readonly DependencyProperty ModelProperty =
            DependencyProperty.Register("Model", typeof(T), typeof(FilterViewBase<T>), new FrameworkPropertyMetadata(default(T), new PropertyChangedCallback(OnModelChanged)));
        ...
        public override void OnApplyTemplate()
        {
            ...
            txtName = GetTemplateChild(PART_Name) as TextBlock;
            InitializeBindings();
        }
        /// <summary>
        ...
        private void InitializeBindings()
        {
            if (txtName != null) 
            {
                txtName.SetBinding(TextBlock.TextProperty, new Binding("Model.Name")
                {
