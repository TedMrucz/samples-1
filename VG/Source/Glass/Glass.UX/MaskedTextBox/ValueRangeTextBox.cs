    ...
    public class ValueRangeTextBox : AutoSelectTextBox
    {
        static ValueRangeTextBox()
        {
            ValueRangeTextBox.TextProperty.OverrideMetadata(typeof(ValueRangeTextBox),
                                                     new FrameworkPropertyMetadata(null, new CoerceValueCallback(ValueRangeTextBox.TextCoerceValueCallback)));

            ValueRangeTextBox.AcceptsReturnProperty.OverrideMetadata(typeof(ValueRangeTextBox),
                                                     new FrameworkPropertyMetadata(false, null, new CoerceValueCallback(ValueRangeTextBox.AcceptsReturnCoerceValueCallback)));

            ValueRangeTextBox.AcceptsTabProperty.OverrideMetadata(typeof(ValueRangeTextBox),
                                                     new FrameworkPropertyMetadata(false, null, new CoerceValueCallback(ValueRangeTextBox.AcceptsTabCoerceValueCallback)));
        ...
        public static readonly DependencyProperty BeepOnErrorProperty = DependencyProperty.Register("BeepOnError", typeof(bool), typeof(ValueRangeTextBox), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty FormatProviderProperty = DependencyProperty.Register("FormatProvider", typeof(IFormatProvider), typeof(ValueRangeTextBox),
                                                 new UIPropertyMetadata(null, new PropertyChangedCallback(ValueRangeTextBox.FormatProviderPropertyChangedCallback)));
        ...
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.Register("MinValue", typeof(object), typeof(ValueRangeTextBox),
                                                new UIPropertyMetadata(null, null, new CoerceValueCallback(ValueRangeTextBox.MinValueCoerceValueCallback)));
        ...
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.Register("MaxValue", typeof(object), typeof(ValueRangeTextBox),
                                                 new UIPropertyMetadata(null, null, new CoerceValueCallback(MaxValueCoerceValueCallback)));
        ...
        public static readonly DependencyProperty NullValueProperty = DependencyProperty.Register("NullValue", typeof(object), typeof(ValueRangeTextBox),
                                               new UIPropertyMetadata(null, new PropertyChangedCallback(ValueRangeTextBox.NullValuePropertyChangedCallback), new CoerceValueCallback(NullValueCoerceValueCallback)));
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(object), typeof(ValueRangeTextBox),
          new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(ValueRangeTextBox.ValuePropertyChangedCallback), new CoerceValueCallback(ValueRangeTextBox.ValueCoerceValueCallback)));
        ...
        public static readonly DependencyProperty ValueDataTypeProperty = DependencyProperty.Register("ValueDataType", typeof(Type), typeof(ValueRangeTextBox),
          new UIPropertyMetadata(null, new PropertyChangedCallback(ValueRangeTextBox.ValueDataTypePropertyChangedCallback), new CoerceValueCallback(ValueRangeTextBox.ValueDataTypeCoerceValueCallback)));
        ...
        internal virtual void ValidateDataType(Type type)
        {
            ...
            if ((minValue != null) || (maxValue != null) || ((nullValue != null) && (nullValue != DBNull.Value)))
            {
        ...
        {
            get { return (bool)this.GetValue(ValueRangeTextBox.HasValidationErrorProperty); }
        }
        ...
        private static readonly DependencyPropertyKey HasParsingErrorPropertyKey = DependencyProperty.RegisterReadOnly("HasParsingError", typeof(bool), typeof(ValueRangeTextBox), new UIPropertyMetadata(false));
        ...
        {
            get { return (bool)this.GetValue(ValueRangeTextBox.IsValueOutOfRangeProperty); }
        }
        ...
        {
            get { return flags[(int)ValueRangeTextBoxFlags.IsInValueChanged]; }
            private set { flags[(int)ValueRangeTextBoxFlags.IsInValueChanged] = value; }
        }

        internal bool IsForcingValue
        {
            get { return flags[(int)ValueRangeTextBoxFlags.IsForcingValue]; }
            private set { flags[(int)ValueRangeTextBoxFlags.IsForcingValue] = value; }
        }

        internal bool IsForcingText
        {
            get { return flags[(int)ValueRangeTextBoxFlags.IsForcingText]; }
            private set { flags[(int)ValueRangeTextBoxFlags.IsForcingText] = value; }
        }

        internal bool IsNumericValueDataType
        {
            get { return flags[(int)ValueRangeTextBoxFlags.IsNumericValueDataType];  }
            private set { flags[(int)ValueRangeTextBoxFlags.IsNumericValueDataType] = value; }
        }
        ...
        {
            get { return imePreCompositionCachedTextInfo != null; }
        }

        private bool IsFinalizingInitialization
        {
            get { return flags[(int)ValueRangeTextBoxFlags.IsFinalizingInitialization]; }
            set { flags[(int)ValueRangeTextBoxFlags.IsFinalizingInitialization] = value; }
        }
        ...
        {
            Debug.Assert(imePreCompositionCachedTextInfo == null, "EndIMEComposition should have been called before another IME Composition starts.");

            imePreCompositionCachedTextInfo = new CachedTextInfo(this);
        }

        internal void EndIMEComposition()
        {
            CachedTextInfo cachedTextInfo = imePreCompositionCachedTextInfo.Clone() as CachedTextInfo;
            imePreCompositionCachedTextInfo = null;
        ...
        private CachedTextInfo imePreCompositionCachedTextInfo;
